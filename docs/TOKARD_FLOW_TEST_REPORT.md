...
4. Completing with a returned model ID routes correctly and charges 7 credits for simulated usage. The real account balance becomes 9,993 and its reserved balance returns to zero.
